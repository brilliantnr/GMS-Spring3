			...
			<section class="banner-area">
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-between">
						...
						<img class="img-fluid" src="${context}/resources/img/v.gif" alt="">
						</div>
					</div>
				</div>					
			</section>
				...
				<div class="container">
					<div class="row align-items-center justify-content-between">
						<div class="col-lg-6 col-md-6 home-about-left">
							<img class="img-fluid" src="${context}/resources/img/jm.gif" alt="">
						</div>
                        ...
                        <div class="row grid">
                            ...
                            <div class="single-portfolio col-sm-4 all raster">
                            	<div class="relative">
									...
									<a href="${context}/resources/img/p6.jpg" class="img-pop-up">	
									  <div class="middle">
									    <div class="text align-self-center d-flex"><img src="${context}/resources/img/preview.png" alt=""></div>
									  </div>
									</a>                             		
